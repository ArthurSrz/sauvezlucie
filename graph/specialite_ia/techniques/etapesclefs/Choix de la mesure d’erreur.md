...
type: "technique"
tags: ["métrique", "évaluation", "performance", "optimisation", "validation"]
relations:
  - type: "rdfs:subClassOf"
    target: "[[Les étapes clés pour concevoir un système d'Intelligence Artificielle]]"
  - type: "rdfs:seeAlso"
    target: ["[[Choix du modèle]]", "[[Choix de la fonction de minimisation]]"]
---
...
### [[Matrice de confusion et dérivés]]
