...
type: "technique"
tags: ["sélection de modèle", "architecture", "hyperparamètres", "complexité", "inférence"]
relations:
  - type: "rdfs:subClassOf"
    target: "[[Les étapes clés pour concevoir un système d'Intelligence Artificielle]]"
  - type: "rdfs:seeAlso"
    target: ["[[Préparation des données]]", "[[Choix de la mesure d'erreur]]", "[[Modèles Statistiques]]", "[[Réseaux de Neurones]]"]
---
...
### [[Taxonomie des modèles d'apprentissage automatique]]
### [[Compromis biais-variance]]
### [[AutoML et sélection automatique de modèles]]
