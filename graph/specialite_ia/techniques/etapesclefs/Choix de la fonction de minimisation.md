...
type: "technique"
tags: ["optimisation", "fonction de coût", "gradient", "convergence", "rétropropagation"]
relations:
  - type: "rdfs:subClassOf"
    target: "[[Les étapes clés pour concevoir un système d'Intelligence Artificielle]]"
  - type: "rdfs:seeAlso"
    target: ["[[Choix de la mesure d'erreur]]", "[[Entraînement]]"]
---
...
### [[Fonctions de coût courantes]]
### [[Algorithmes d'optimisation par gradient]]
